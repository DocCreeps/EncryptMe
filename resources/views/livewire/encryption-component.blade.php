    ...
    <div class="w-1/3">
        <form wire:submit.prevent="encrypt">
            <div class="mb-4">
                ...
                <textarea id="input" name="input" class="form-input w-full" rows="5" wire:model.defer="input"></textarea>
            </div>

            <div class="mb-4">
                <label for="mode" class="block font-medium mb-2">Mode de chiffrement :</label>
                <select id="mode" name="mode" class="form-select w-full" wire:model.defer="mode">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="key" name="key" class="form-input w-full" wire:model.defer="key">
            </div>
